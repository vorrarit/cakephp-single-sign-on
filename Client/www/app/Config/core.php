 ...
 */
	Configure::write('Session', array(
		...
		'ini' => array(
			...
			'session.cookie_domain' => '.zicure.local'
		),
		'cookie' => 'session'
	));
...
Configure::write('Zicure.OAuth2', array(
	'loginUrl' => 'http://auth.zicure.local/OAuth2/login/testclient',
	'tokenUrl' => 'http://oauth-web/OAuth2/tokenRequest.json',
	'logoutUrl' => 'http://auth.zicure.local/OAuth2/logout',
	'clientId' => 'testclient',
	'secret' => 'testsecret'
));
